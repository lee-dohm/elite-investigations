defmodule EliteInvestigationsWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: EliteInvestigationsWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/elite_investigations_web/templates",
        namespace: EliteInvestigationsWeb
      ...
      import EliteInvestigationsWeb.RenderHelpers
    end
  end
